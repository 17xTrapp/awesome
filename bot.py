# bot.py — NAA Utilities (ADVANCED) + UPDATED Stats Bot (MERGED)
#
# ✅ Admin-only /addteam + /removeteam
# ✅ /offer AUTO-detects your team from the team role you're wearing (must be on 1 registered team)
# ✅ /offer uses ROLE WHITELIST (GM/HC/AHC) — NO “registered owner” required
# ✅ /release uses SEPARATE ROLE WHITELIST (GM/HC/AHC) — NO “registered owner” required
# ✅ Offer alerts + Release alerts go to SEPARATE configurable channels
# ✅ No duplicate embeds:
#    - Offer accept/decline edits the original offer message ONLY (no extra message)
#    - Release sends ONLY to the configured release-alert channel (command reply is ephemeral)
# ✅ CONTRACT ACCEPTED / CONTRACT DENIED titles
# ✅ Accept keeps Free Agent role (does NOT remove it)
# ✅ Release removes team role AND adds Free Agent role
# ✅ Stats system merged back (/insert qb|wr|cb|de|rb) with RB header auto-detect
# ✅ Stats commands PUBLIC results (everyone can see), but “Not allowed” is EPHEMERAL
#
# ENV (.env) keys you should have:
# BOT_TOKEN=...
# TEST_GUILD_ID=...               # for fast dev sync
...
# SUCCESS_GIF_URL=...
#
# OWNER_IDS=123,456               # owners who can manage /statswhitelist
#
# Optional sheet tab names:
# QB_SHEET=QB
# WR_SHEET=WR
# CB_SHEET=CB
# DE_SHEET=DE
# RB_SHEET=RB
#
# STATS_WHITELIST_FILE=stats_whitelist.json
